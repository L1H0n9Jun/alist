...
func InitialSettings() []model.SettingItem {
	...
	initialSettingItems = []model.SettingItem{
		...
		{Key: conf.Announcement, Value: "### repo\nhttps://github.com/L1H0n9Jun/alist", Type: conf.TypeText, Group: model.SITE},
		...
		// style settings
		{Key: conf.Logo, Value: "https://cdn.hli.im/assets/img/alist.svg?referer=lihj", Type: conf.TypeText, Group: model.STYLE},
		{Key: conf.Favicon, Value: "https://cdn.hli.im/assets/img/alist.svg?referer=lihj", Type: conf.TypeString, Group: model.STYLE},
	...
	"pdf": {
		"PDF.js":"https://mozilla.github.io/pdf.js/web/viewer.html?file=$e_url",
	},
	"epub": {
		...
		//}`, Type: conf.TypeText, Group: model.PREVIEW},
		{Key: "audio_cover", Value: "https://cdn.hli.im/assets/img/alist.svg?referer=lihj", Type: conf.TypeString, Group: model.PREVIEW},
...
(?U)access_token=(.*)&`,
		...
		{Key: conf.OcrApi, Value: "https://0.0.0.0/ocr/file/json", Type: conf.TypeString, Group: model.GLOBAL},
